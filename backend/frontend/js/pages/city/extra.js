    ...
    return {
      ...
      strategyTypes: [
        { key: 'guide', label: '導遊', endpoint: 'cityGuide',
          ...
          svg: '<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><circle cx="8.5" cy="4.5" r="3.5" stroke="#1a1a1a" stroke-width="1.6"/><path d="M4.5 21v-6a4 4 0 0 1 4-3.5" stroke="#1a1a1a" stroke-width="1.6" stroke-linecap="round"/><line x1="16.5" y1="2" x2="16.5" y2="13" stroke="#1a1a1a" stroke-width="1.6" stroke-linecap="round"/><path d="M16.5 2l4.5 2.5-4.5 2.5z" fill="#7C5CFF" stroke="none"/></svg>',
        ...
        { key: 'attraction', label: '景點', endpoint: 'cityAttraction',
          ...
          svg: '<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><path d="M3 22l5-10 3 4 2-3 4-5.5 3.5 7.5" stroke="#1a1a1a" stroke-width="1.6" stroke-linejoin="round"/><path d="M6 11c-1.5 0-3 .8-3 2s1.5 2 3 2h8c1.2 0 2.2-.8 2.2-1.8 0-1-.8-2-2-1.8-.3-1.8-2-2.5-3.5-1.8" stroke="#1a1a1a" stroke-width="1.6" stroke-linecap="round"/><circle cx="16" cy="8.5" r="1.5" fill="#06D6A0" stroke="none"/></svg>',
        ...
        { key: 'restaurant', label: '餐廳', endpoint: 'cityRestaurant',
          ...
          svg: '<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><path d="M4 7.5c0-2 3.5-3 8-3s8 1 8 3" stroke="#1a1a1a" stroke-width="1.6" stroke-linecap="round"/><rect x="4.5" y="8.5" width="15" height="2.8" rx="0.5" fill="#FF8C42" stroke="none"/><path d="M4 13c0 2 3.5 3 8 3s8-1 8-3" stroke="#1a1a1a" stroke-width="1.6" stroke-linecap="round"/><rect x="9" y="17" width="6" height="5" rx="1.3" stroke="#1a1a1a" stroke-width="1.6"/><line x1="12" y1="14.5" x2="12" y2="17" stroke="#1a1a1a" stroke-width="1.6" stroke-linecap="round"/></svg>',
        ...
        { key: 'shopping', label: '購物', endpoint: 'cityShopping',
          ...
          svg: '<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><path d="M7 3L3.5 7v13a2 2 0 0 0 2 2h13a2 2 0 0 0 2-2V7l-3.5-4z" stroke="#1a1a1a" stroke-width="1.6" stroke-linejoin="round"/><path d="M3.5 7h17" stroke="#1a1a1a" stroke-width="1.6"/><path d="M7 3a5 5 0 0 1 10 0" stroke="#1a1a1a" stroke-width="1.6" stroke-linecap="round"/><path d="M9 7.5V6" stroke="#EF476F" stroke-width="2.2" stroke-linecap="round"/><path d="M15 7.5V6" stroke="#EF476F" stroke-width="2.2" stroke-linecap="round"/></svg>',
        ...
        { key: 'accommodation', label: '住宿', endpoint: 'cityAccommodation',
          ...
          svg: '<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><rect x="2" y="7" width="20" height="15" rx="1" stroke="#1a1a1a" stroke-width="1.6"/><rect x="7" y="10" width="3.5" height="12" stroke="#1a1a1a" stroke-width="1.6"/><rect x="13.5" y="10" width="3.5" height="12" stroke="#1a1a1a" stroke-width="1.6"/><rect x="14.5" y="12" width="2" height="3.5" rx="0.3" fill="#A837FF" stroke="none"/><line x1="5" y1="3" x2="5" y2="7" stroke="#1a1a1a" stroke-width="1.6" stroke-linecap="round"/><line x1="12" y1="3" x2="12" y2="7" stroke="#1a1a1a" stroke-width="1.6" stroke-linecap="round"/><line x1="19" y1="3" x2="19" y2="7" stroke="#1a1a1a" stroke-width="1.6" stroke-linecap="round"/></svg>',
        ...
        { key: 'transportation', label: '交通', endpoint: 'cityTransportation',
          ...
          svg: '<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><rect x="2" y="5" width="20" height="12" rx="2" stroke="#1a1a1a" stroke-width="1.6"/><circle cx="7" cy="19" r="2" stroke="#1a1a1a" stroke-width="1.6"/><circle cx="17" cy="19" r="2" stroke="#1a1a1a" stroke-width="1.6"/><rect x="10" y="6.5" width="8" height="4" rx="0.5" fill="#6695FF" stroke="none"/><line x1="12" y1="5" x2="12" y2="17" stroke="#1a1a1a" stroke-width="1" stroke-dasharray="1.5 1.5"/></svg>',
        ...
        { key: 'facility', label: '設施', endpoint: 'cityFacility',
          ...
          svg: '<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><rect x="4" y="5" width="16" height="17" rx="1" stroke="#1a1a1a" stroke-width="1.6"/><rect x="8" y="9" width="3" height="3" rx="0.3" fill="#00D8D5" stroke="none"/><rect x="13" y="9" width="3" height="3" rx="0.3" fill="#00D8D5" stroke="none"/><rect x="8" y="15" width="3" height="3" rx="0.3" stroke="#1a1a1a" stroke-width="1.2"/><rect x="13" y="15" width="3" height="3" rx="0.3" stroke="#1a1a1a" stroke-width="1.2"/><line x1="12" y1="2" x2="12" y2="5" stroke="#1a1a1a" stroke-width="1.6" stroke-linecap="round"/></svg>',
        ...
        { key: 'activity', label: '活動', endpoint: 'cityActivity',
          ...
          svg: '<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><rect x="3" y="4" width="18" height="18" rx="2" stroke="#1a1a1a" stroke-width="1.6"/><line x1="3" y1="9" x2="21" y2="9" stroke="#1a1a1a" stroke-width="1.6"/><line x1="8" y1="2" x2="8" y2="6" stroke="#1a1a1a" stroke-width="1.6" stroke-linecap="round"/><line x1="16" y1="2" x2="16" y2="6" stroke="#1a1a1a" stroke-width="1.6" stroke-linecap="round"/><polygon points="12,11 13.5,14.5 17,14.5 14.5,17 15.5,20.5 12,18.5 8.5,20.5 9.5,17 7,14.5 10.5,14.5" fill="#FFA921" stroke="none"/></svg>',
        ...
        { key: 'ticket', label: '票務', endpoint: 'cityTicket',
          ...
          svg: '<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><rect x="3" y="4" width="18" height="16" rx="2" stroke="#1a1a1a" stroke-width="1.6"/><line x1="14" y1="4" x2="14" y2="20" stroke="#1a1a1a" stroke-width="1.6"/><circle cx="17" cy="8" r="1.2" fill="#4ECDC4" stroke="none"/><circle cx="17" cy="12" r="1.2" fill="#4ECDC4" stroke="none"/><circle cx="17" cy="16" r="1.2" fill="#4ECDC4" stroke="none"/></svg>',
