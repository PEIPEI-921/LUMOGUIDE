...
const MessagePage = {
  template: `
    <div class="page-content"><div class="ds-container-640" style="padding-top:12px;padding-bottom:40px">
      ...
      <!-- Loading -->
      <loading-spinner v-else-if="!messageData && loading" />

      <!-- Message Categories -->
      <template v-else-if="messageData">
        ...
        <div class="ds-card" style="padding:0;overflow:hidden">
          <a v-for="(item, idx) in messageItems" :key="item.key"
            ...
            <div style="flex:1;min-width:0">
              <div style="font-size:14.5px;font-weight:550;color:var(--color-primary-text)">{{ t(item.title) }}</div>
  ...
  mounted() {
    if (UserStore.isLogin) this.fetchMessages();
  }
};
